...
#---
## This script generates daily WIND SPEED for ***1400+*** selected stations, and generates detrended anomalies.
...
#*#*#
script = 'code/dataprep/prep_daily_stationdata_expanded_windspeeds_roll11.py'
#*#*#
...
#    print(i, staid)
    ...
    #*#*#
    # gen daily windspeeds
    da = sta_ds.windspeeds.where(sta_ds.windspeeds > -2e30).resample(time='D').mean().compute()
    ...
    if i==0:
        attrs = da.attrs
        attrs['long_name'] = 'daily average Wind speed at mast height (~10m)'
