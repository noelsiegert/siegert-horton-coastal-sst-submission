...
# ---
#
# # This script compiles ERA5 T profile data (Over the weather stations this time)
...
script = os.getcwd() + '/compile_daily_Era5TProfiles-OverStations.py'

# input (intermediate) files
files = glob.glob('/glade/derecho/scratch/nsiegert/coastal/OverStations.Tprofile.*.nc')
files.sort()
...
full_da.to_dataset(name='T').to_netcdf('/glade/u/home/nsiegert/projects/coastal_sst/data/ALLSTATIONS.OverStations.Tprofile.nc')
...
full_da_anoms.to_dataset(name='T').to_netcdf('/glade/u/home/nsiegert/projects/coastal_sst/data/ALLSTATIONS.OverStations.Tprofile_anoms.nc')
